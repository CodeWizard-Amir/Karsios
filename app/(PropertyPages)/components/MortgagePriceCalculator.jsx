...
const MortgagePriceCalculator = () => {
    ...
    const PropertyPriceCalculatorTool = () => {
      ...
      price = clBathroom ? price * ( 1 + (clBathroom * 0.01)) : price;
      price = clBedroom ? price * (1 + (clBedroom * 0.01)) : price;
...
export default MortgagePriceCalculator